...
namespace nUpdate.Test
{
    ...
    public class UseDynamicUpdateUriTest
    {
        ...
        public void CanConvertPackageUriIp()
        {
            ...
            var updateManager = new UpdateManager(new Uri("http://192.168.1.1/nUpdate/my-app/updates.json"), _publicKey,
                new CultureInfo("en"), new UpdateVersion(literalVersion)) {UseDynamicUpdateUri = true};
            var targetUri =
                new Uri("http://192.168.1.1/nUpdate/my-app/1.0.0.0/6b56500f-6557-4808-a68f-6c6fb32fb3e4.zip");
            var privateObject = new PrivateObject(updateManager);
        ...
        {
            var literalVersion = "1.0.0.0";
            var updatePackageUri =
                new Uri("http://localhost/my-app/nUpdate/1.0.0.0/6b56500f-6557-4808-a68f-6c6fb34fb3e4.zip");
            var updateManager = new UpdateManager(new Uri("http://www.test.de/nUpdate/updates.json"), _publicKey,
                new CultureInfo("en"), new UpdateVersion(literalVersion)) {UseDynamicUpdateUri = true};
        ...
        public void CanConvertPackageUriWithDomainNamePort()
        {
            var literalVersion = "1.0.0.0";
            var updatePackageUri =
                new Uri("http://localhost:8089/nUpdate/my-app/1.0.0.0/6b56500f-6557-4808-a68f-6c6f134fb3e4.zip");
            var updateManager = new UpdateManager(new Uri("http://www.test.com:8081/my-app/updates.json"), _publicKey,
                new CultureInfo("en"), new UpdateVersion(literalVersion)) {UseDynamicUpdateUri = true};
        ...
        public void CanConvertPackageUriWithIpPort()
        {
            var literalVersion = "1.0.0.0";
            var updatePackageUri =
                new Uri("http://127.0.0.1:8089/nUpdate/1.0.0.0/6b56500f-6557-4808-a68f-6c6fb34fb3e4.zip");
            var updateManager = new UpdateManager(new Uri("http://192.168.1.1:8081/nUpdate/updates.json"), _publicKey,
                new CultureInfo("en"), new UpdateVersion(literalVersion)) {UseDynamicUpdateUri = true};
        ...
        public void CanConvertStatisticsUriWithDomainNamePort()
        {
            ...
            var updateManager = new UpdateManager(new Uri("http://www.test.com:8081/nUpdate/updates.json"), _publicKey,
                new CultureInfo("en"), new UpdateVersion(literalVersion)) {UseDynamicUpdateUri = true};
        ...
        public void CanConvertStatisticsUriWithIpPort()
        {
            ...
            var updateManager = new UpdateManager(new Uri("http://192.168.1.1:8081/nUpdate/my-app/updates.json"),
                _publicKey, new CultureInfo("en"), new UpdateVersion(literalVersion)) {UseDynamicUpdateUri = true};
