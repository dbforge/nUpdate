    ...
    public partial class ExplorerNavigationButton
    {
        private class AeroTemplate : Template
        {
            ...
            public AeroTemplate()
            {
                ...
                path1.AddEllipse(new RectangleF(backgroundRect.X - 2, backgroundRect.Y, backgroundRect.Width + 4,
                ...
                var arrowBrush = new LinearGradientBrush(backgroundRect, Color.Transparent, Color.Transparent,
                ...
                var disabledArrowBrush = new LinearGradientBrush(backgroundRect, Color.Transparent, Color.Transparent,
                    LinearGradientMode.Vertical);
                ...
                path3.AddEllipse(new RectangleF(backgroundRect.X - 6, backgroundRect.Y, backgroundRect.Width + 12,
                ...
                path4.AddEllipse(new RectangleF(backgroundRect.X - 2, backgroundRect.Y, backgroundRect.Width + 4,
