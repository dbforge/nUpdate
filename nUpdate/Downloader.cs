...
namespace nUpdate
{
    ...
    {
        internal static async Task DownloadFile(Uri fileUri, string localFilePath, long totalSize, CancellationToken cancellationToken, IProgress<UpdateProgressData> progress)
        {
            long received = 0;
