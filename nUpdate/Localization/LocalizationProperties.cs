...
namespace nUpdate.Localization
{
    public class LocalizationProperties
    {
        internal LocalizationProperties()
        {
            ...
            InstallerFileInUseError = "The installer cannot overwrite the file '{0}' because it is being used by another process. Terminate all applications that block the access and try again by pressing \"OK\".";
